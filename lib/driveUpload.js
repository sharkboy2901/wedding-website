 ...
 *
 * 1. OAuth2 refresh token (works with personal Gmail accounts):
 *    GOOGLE_OAUTH_CLIENT_ID, GOOGLE_OAUTH_CLIENT_SECRET, GOOGLE_OAUTH_REFRESH_TOKEN
 *
 * 2. Service account JSON (works with Workspace Shared Drives):
...
function getDriveClient() {
  // ── OAuth2 refresh token (preferred for personal Gmail accounts) ──────────
  ...
  // ── Service account JSON (fallback, works with Workspace Shared Drives) ───
